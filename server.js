...
app.post('/upload', upload.single('file'), async (req, res) => {
    ...
    try {
        ...
        const result = await model.generateContent([
            ...
            { text: `Can you summarize the content of this resume? and compare information related to the job description: ${jobDescription}. tell me if i am a good fit for the role or not. If yes the tell me what should i write for the question
